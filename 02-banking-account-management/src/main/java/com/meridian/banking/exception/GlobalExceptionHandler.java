...
import com.meridian.banking.dto.ApiError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleAccountNotOperable(AccountNotOperableException ex, HttpServletRequest request) {
        return build(HttpStatus.CONFLICT, ex.getMessage(), request);
    }
