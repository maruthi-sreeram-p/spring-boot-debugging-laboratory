...
import com.vantage.inventory.dto.ApiError;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ReceiptRuleException.class)
    public ResponseEntity<ApiError> handleReceiptRule(ReceiptRuleException ex, HttpServletRequest request) {
